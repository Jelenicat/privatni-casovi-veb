...
if ((nacinCasa || professor.nacinCasova?.online) === 'online') {
  ...
  const vremeBezDvotacke = selectedSlot.vreme.replace(':', ''); // npr. 17:45 → 1745
jitsiLink = `https://meet.jit.si/${imeProfesora}-${selectedSlot.dan}-${vremeBezDvotacke}`.replace(/\s+/g, '');
